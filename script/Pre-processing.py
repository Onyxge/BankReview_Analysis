"""
Data Preprocessing Script (REGEX VERSION)
...
- Normalizes dates
- Cleans text data
- Filters out Amharic reviews using REGEX (instead of langdetect)
...
class ReviewPreprocessor:
    ...
    def __init__(self, input_path=None, output_path=None):
        ...
        # We save this to a DIFFERENT file so we don't overwrite your good data
        self.output_path = os.path.join(DATA_PATHS['processed_dir'], 'reviews_processed_regex.csv')
    ...
    def clean_text(self):
        ...
        # Unicode range for Ethiopic script: \u1200-\u137F
        ...
        # Keep rows that do NOT have Amharic
    ...
    def generate_report(self):
        ...
        print("\n" + "=" * 60)
        print("PREPROCESSING REPORT (REGEX VERSION)")
        print("=" * 60)
    ...
    def process(self):
        ...
        print("=" * 60)
        print("STARTING DATA PREPROCESSING (REGEX)")
        print("=" * 60)
